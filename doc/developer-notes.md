...
Paccoin Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Paccoin Core, where everyone uses
...
pay attention to for reviewers of Paccoin Core code.

General Paccoin Core
----------------------
...
- For `strprintf`, `LogPrint`, `LogPrintf` formatting characters don't need size specifiers
  ...
  - *Rationale*: Paccoin Core uses tinyformat, which is type safe. Leave them out to avoid confusion
