...
Only requiring some minor changes is paccoin.cpp.
...
Changes to paccoin.cpp
----------------------
paccoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
