...
#Set env vars
buildDir = BUILDDIR
if "PACD" not in os.environ:
    os.environ["PACD"] = buildDir + '/src/paccoind' + EXEEXT
if "PACCLI" not in os.environ:
    os.environ["PACCLI"] = buildDir + '/src/paccoin-cli' + EXEEXT
...
#    'rpcbind_test.py', #temporary, bug in libevent, see #6655
    ...
    'mempool_packages.py',
    'maxuploadtarget.py',
    # 'replace-by-fee.py', # RBF is disabled in Paccoin Core
]
