...
static const CAmount nHighTransactionFeeWarning = 200 * COIN;
//! -fallbackfee default
...
static const CAmount nHighTransactionMaxFeeWarning = 2 * nHighTransactionFeeWarning;
...
enum AvailableCoinsType
{
    ...
    ONLY_DENOMINATED,
    ONLY_NONDENOMINATED,
    ONLY_500000, // find masternode outputs including locked ones (use with caution)
