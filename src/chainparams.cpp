...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("paccoinpay.io", "dnsseed.paccoinpay.io"));

        // Paccoin addresses start with 'X'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,76);
        // Paccoin script addresses start with '7'
...
public:
    CTestNetParams() {
        ...
        // Testnet Paccoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Testnet Paccoin script addresses start with '8' or '9'
...
public:
    CRegTestParams() {
        ...
        // Regtest Paccoin addresses start with 'y'
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1,140);
        // Regtest Paccoin script addresses start with '8' or '9'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1,19);
