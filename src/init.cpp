...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-enableprivatesend=<n>", strprintf(_("Enable use of automated PrivatePAC for funds stored in this wallet (0-1, default: %u)"), 0));
    strUsage += HelpMessageOpt("-privatesendmultisession=<n>", strprintf(_("Enable multiple PrivatePAC mixing sessions per block, experimental (0-1, default: %u)"), DEFAULT_PRIVATESEND_MULTISESSION));
    ...
    strUsage += HelpMessageOpt("-enableinstantsend=<n>", strprintf(_("Enable InstantPAC, show confirmations for locked transactions (0-1, default: %u)"), 1));
...
bool AppInitMain(boost::thread_group& threadGroup, CScheduler& scheduler)
{
    ...
    // ********************************************************* Step 11c: schedule PAC-specific tasks
