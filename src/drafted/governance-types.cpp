...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "PaccoinNetwork") type = PaccoinNetwork;
    if(strType == "PaccoinNetworkVariable") type = PaccoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == PaccoinNetwork) s = "PaccoinNetwork";
    if(type == PaccoinNetworkVariable) s = "PaccoinNetworkVariable";
