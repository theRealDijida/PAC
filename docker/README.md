...
official/supported Docker Images found at https://hub.docker.com/r/paccoinpay/paccoind/
...
**NOTE: Please update the image description at https://hub.docker.com/r/paccoinpay/paccoind-develop/ when changing the above text**